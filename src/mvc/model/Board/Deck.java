...
//    }
     ...
     * <p>
     * <b>Postcondition</b> Draws card from deck and removes it from deck
     *
     * @return First card from deck
     */
    public Card drawCard() {
        if( isEmpty() ) throw new IllegalArgumentException("Drawing Card from empty deck");
        Card c = deck.get(0);
        deck.remove(0);
        return c;
    }
